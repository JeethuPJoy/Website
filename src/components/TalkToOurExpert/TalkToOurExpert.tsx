...
const COUNTRIES = (allCountries as unknown as RawCountry[]).filter(
  (country, index, list) => list.findIndex((entry) => entry.iso2 === country.iso2) === index
);
...
function ArrowDownIcon({ open }: { open?: boolean }) {
  return (
    <svg
      ...
      className={`tte-chevron${open ? " tte-chevron-open" : ""}`}
    >
      <path
...
function PlayIcon() {
  return (
    <svg width="40" height="45" viewBox="0 0 40 45" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M38 20.6699C39.3333 21.4408 39.3333 23.3743 38 24.1453L4.25 43.6367C2.91667 44.4077 1.25 43.4409 1.25 41.899L1.25 2.91616C1.25 1.37429 2.91667 0.407462 4.25 1.17839L38 20.6699Z"
        stroke="#FFFFFF"
        strokeWidth="2"
        strokeLinejoin="round"
      />
...
export default function TalkToOurExpert({ isOpen, onClose, onPlayClick }: TalkToOurExpertProps) {
  ...
  const selectedCountry = useMemo(
    () => COUNTRIES.find((country) => country.iso2 === formData.countryIso2) ?? COUNTRIES[0],
          ...
          <div className="tte-photo-panel">
            <div className="tte-photo-frame">
              <div className="tte-photo-inner">
                <Image
                  src="/images/talk-to-expert/expert-photo.png"
                  alt="NeuroLXP learning expert wearing a headset, ready to help"
                  fill
                  sizes="(max-width: 1024px) 80vw, 434px"
                  className="tte-photo"
                />
                <button
                  type="button"
                  className="tte-play-button"
                  onClick={() => onPlayClick?.()}
            ...
            <div className="tte-form-surface">
              {submitted ? (
                <div className="tte-success" role="status">
                  ...
                  <p className="tte-success-body">
                    Our expert has received your query and will reach out to you shortly.
                  </p>
                </div>
              ) : (
                <form className="tte-form" onSubmit={handleSubmit} noValidate>
                  <div className="tte-field">
                    ...
                    <div
                      className={`tte-input-shell${touched.fullName && errors.fullName ? " tte-input-shell-error" : ""}`}
                    >
                      <IconBubble>
                        <UserIcon />
                      </IconBubble>
                      <input
                        ...
                        aria-describedby={touched.fullName && errors.fullName ? "tte-fullName-error" : undefined}
                      />
                    </div>
                  ...
                  <div className="tte-field">
                    ...
                    <div className={`tte-input-shell${touched.email && errors.email ? " tte-input-shell-error" : ""}`}>
                      ...
                      <input
                        ...
                        aria-describedby={touched.email && errors.email ? "tte-email-error" : undefined}
                      />
                    </div>
                  ...
                  <div className="tte-field">
                    ...
                    <div className="tte-phone-row">
                          ...
                          <div className="tte-country-panel" role="listbox">
                            ...
                            <ul className="tte-country-list">
                              {filteredCountries.map((country) => (
                                <li key={country.iso2}>
                                  <button
                                    ...
                                    className={`tte-country-option${
                                      country.iso2 === formData.countryIso2 ? " tte-country-option-active" : ""
                                    }`}
                                    onClick={() => {
                              ...
                              {filteredCountries.length === 0 && (
                                <li className="tte-country-empty">No countries match your search.</li>
                              )}
                            </ul>
                          </div>
                        )}
                      ...
                      <div
                        className={`tte-input-shell tte-input-shell-grow${
                          touched.phoneNumber && errors.phoneNumber ? " tte-input-shell-error" : ""
                        }`}
                      >
                        <IconBubble>
                          <PhoneIcon />
                        ...
                        <input
                          ...
                          onChange={(event) =>
                            handleFieldChange("phoneNumber", event.target.value.replace(/[^0-9]/g, ""))
                          }
                          onBlur={() => handleBlur("phoneNumber")}
                          aria-invalid={touched.phoneNumber && Boolean(errors.phoneNumber)}
                          aria-describedby={touched.phoneNumber && errors.phoneNumber ? "tte-phone-error" : undefined}
                        />
                      </div>
                    </div>
                  ...
                  <div className="tte-field" ref={interestDropdownRef}>
                    ...
                    <button
                      type="button"
                      className="tte-input-shell tte-interest-trigger"
                        ...
                        {INTEREST_OPTIONS.map((option) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span className={`tte-interest-option-label${checked ? " tte-interest-option-label-active" : ""}`}>
                                {option}
                              </span>
                            </button>
                          );
                  ...
                  <label className="tte-consent">
                    <input
                      type="checkbox"
                      className="tte-consent-checkbox"
                      ...
                      aria-describedby={touched.consent && errors.consent ? "tte-consent-error" : undefined}
                    />
