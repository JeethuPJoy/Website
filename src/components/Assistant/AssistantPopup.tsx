...
export default function Assistant({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div
      ...
      <div className="assistant-popup" role="dialog" aria-modal="true" aria-label="NeuroLXP Assistant" ref={dialogRef} tabIndex={-1}>
        <button type="button" className="assistant-close" onClick={onClose} aria-label="Close assistant">
          <CloseIcon className="assistant-close-icon" />
        </button>
          ...
          <div className="assistant-bottom">
            <div className="assistant-input-container">
              <div className="assistant-input-wrapper">
                <input id="assistant-input" type="text" className="assistant-input" placeholder="Type Your College/Institution Name..." aria-label="College, Institution, University, or Corporate Name" autoComplete="organization" />
                <button className="assistant-send-button">
                  <svg className="send-icon" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Send Button">
