...
function TickRow({
  ...
  return (
    <div className={stretch ? 'frameParent21' : 'frameParent19'}>
      ...
      <div className={stretch ? 'assessRisksBefore' : 'understandCreditLoans'}>
        {label}
      </div>
    </div>
  );
    ...
    <div className={'image20Parent'}>
      <div className={wide ? 'image21Container' : 'image21Parent'}>
        <div className={wide ? 'checkmarkBadge03Container' : 'checkmarkBadge03Parent'}>
          <Image
            className={wide ? 'checkmarkBadge03Icon3' : 'checkmarkBadge03Icon'}
...
export default function FinancialLiteracyPage() {
  return (
    <PageScaler>
      {/* Ellipse 359 — Figma: 1345.19 × 906.73 */}
      <div className={'wrapperEllipse359'} aria-hidden="true" />

      {/* Breadcrumb — Locofy frameDiv (sibling above hero) */}
      ...
      <div className={'frameParent2'}>
        <div className={'frameParent3'}>
          ...
          <div className={'buildConfidenceToContainer'}>
            <span className={'buildConfidenceTo'}>
              Build confidence to budget, save, invest and make smarter financial decisions.
            </span>
            <b className={'buildConfidenceTo'}>
              NeuroLXP delivers engaging financial literacy.
            </b>
          </div>
        </div>
      ...
      <div className={'frameParent5'}>
        <div className={'frameParent6'}>
          ...
          <div className={'buildTheConfidenceToManageParent'}>
            ...
            <div className={'developPracticalFinancial'}>
              Develop practical financial skills for everyday decisions and long-term success.
            </div>
          </div>
        </div>
      ...
      <div className={'frameParent14'}>
        <div className={'frameParent15'}>
          <div className={'frameParent16'}>
            ...
            <div className={'buildTheSkills'}>
              Build the skills to compare options, manage risks, and make informed money decisions.
            </div>
          </div>
          <div className={'frameParent18'}>
            ...
            />
            <TickRow
              label="Spend wisely, save for tomorrow"
              color="#861109"
              tick="/icons/tick.svg"
              stretch
            />
        ...
        <div className={'ellipseParent'}>
          ...
          <div className={'theseSkillsBuildConfidenceParent'}>
            <b className={'theseSkillsBuildContainer'}>
              <span className={'empoweringSmarter'}>
                These Skills Build confidence for a stronger{' '}
              </span>
      ...
      <div className={'frameParent23'}>
        <div className={'buildTheConfidenceToManageParent'}>
          ...
          <div className={'buildResponsibleFinancialHaParent'}>
            <b className={'buildResponsibleFinancial'}>
              Build Responsible Financial Habits
            </b>
            <div className={'buildTheSkills'}>
              Financial literacy helps learners build responsible money habits for long-term
              financial well-being Learn to:
            </div>
          </div>
        </div>
      ...
      <div className={'frameParent28'}>
        ...
        <div className={'frameParent29'}>
          <div className={'frameParent16'}>
            ...
            <div className={'buildTheSkills'}>
              Empowering individuals with practical money skills at every stage of life.
            </div>
          </div>
      ...
      <div className={'image20Parent3'}>
        ...
        <svg
          className={'ctaBorderFrame'}
          viewBox="0 0 1232 361"
        ...
        >
          ...
          <path
            className={'ctaBorderPath'}
            d="M9.25 1.25H1031.75A200 200 0 0 1 1230.75 201.25V352.75A8 8 0 0 1 1222.75 359.75H200.25A200 200 0 0 1 1.25 159.75V9.25A8 8 0 0 1 9.25 1.25Z"
            stroke="url(#ctaBorderGradient)"
            strokeWidth="2.5"
            strokeDasharray="8 8"
            vectorEffect="non-scaling-stroke"
          />
        </svg>
        {/* Fluid border — stretches to full card edge (tablet / laptop / mobile) */}
        <svg
          className={'ctaBorderFrameMobile'}
          viewBox="0 0 100 100"
          preserveAspectRatio="none"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        ...
        >
          ...
          <path
            className={'ctaBorderPath'}
            d="M5 2.5H78A19.5 19.5 0 0 1 97.5 22V95A2.5 2.5 0 0 1 95 97.5H22A19.5 19.5 0 0 1 2.5 78V5A2.5 2.5 0 0 1 5 2.5Z"
            stroke="url(#ctaBorderGradientMobile)"
            strokeWidth="2"
            strokeDasharray="6 6"
            vectorEffect="non-scaling-stroke"
          />
        ...
        <div className={'frameParent36'}>
          ...
          <div className={'financialConfidenceStartsHeParent'}>
            ...
            <div className={'neurolxpEmpowersLearners'}>
              NeuroLXP empowers learners with practical financial skills for smarter decisions and
