    ...
    <main className={styles.interactiveGamifiedLearnin} id="main-content">
        ...
        <div className={styles.frameParent52}>
          ...
          <div className={styles.frameWrapper16}>
            <div className={styles.frameParent54}>
              ...
              <Image className={styles.collageCustomerExperienceCoIcon} src="/images/students-gamification.webp" width={693} height={583} sizes="(max-width: 768px) 100vw, 693px" alt="" />
      ...
      <div className={styles.frameParent73}>
        ...
        <div className={styles.masteryImageFrame}>
          <Image className={styles.masteryImage} src="/images/ellipse.webp" width={624} height={525} sizes="(max-width: 768px) 100vw, 624px" alt="Learner attending an online session" />
        </div>
      </div>
    </main>
  );
