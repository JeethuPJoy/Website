...
function SkillCard({ line1, line2, corner }: { line1: string; line2: string; corner: keyof typeof SKILL_DOTS }) {
  return (
    <div className={`skillCard skillCard-${corner}`} style={{ "--skill-accent": SKILL_DOTS[corner] } as CSSProperties}>
      <div className={"skillCardDot"} style={{ backgroundColor: SKILL_DOTS[corner] }} aria-hidden="true" />
...
function PillCard({ label, accent }: { label: string; accent: string }) {
  return (
    <div className={"pillCard"} style={{ "--pill-accent": accent } as CSSProperties}>
...
function AudienceCard({ label, color }: { label: string; color: string }) {
  return (
    <div className={"audienceCard"} style={{ "--audience-color": color } as CSSProperties}>
      ...
      <PageScaler>
              ...
              <div className={"frameWrapper3"}>
                <div className={"image20Parent"}>
                  ...
                  <div className={"frameParent3"}>
                    ...
                    <div className={"solveRealWorldChallenges"}>Solve real-world challenges and build coding confidence.</div>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <Image className={"businessStyleYoungBeautifulIcon"} src="/images/hero-people.webp" width={663} height={541} sizes="663px" alt="" priority />
            ...
            <div className={"heroTechStripTrack"}>
              <div className={"heroTechStrip"}>
                <div className={`heroStripSeg heroStripPractice`}>
                  <Image className={"heroStripShape"} src="/icons/rect-3.svg" width={225} height={98} alt="" />
                  <div className={"heroStripContent"}>
                    <Image className={"heroStripIcon"} src="/icons/code-xml-1.svg" width={45} height={43} alt="" />
                ...
                <div className={`heroStripSeg heroStripThink`}>
                  <Image className={"heroStripShape"} src="/icons/rect-3-1.svg" width={253} height={98} alt="" />
                  <div className={"heroStripContent"}>
                    <Image className={"heroStripIcon"} src="/icons/ai-brain-01-1.svg" width={36} height={36} alt="" />
                    <span className={"heroStripLabel"}>
                      <b>Think Logically</b>
                    </span>
                  </div>
                ...
                <div className={`heroStripSeg heroStripShowcase`}>
                  <Image className={"heroStripShape"} src="/icons/rect-4.svg" width={253} height={98} alt="" />
                  <div className={"heroStripContent"}>
                    <Image className={"heroStripIcon"} src="/icons/champion.svg" width={41} height={43} alt="" />
                    <span className={"heroStripLabel"}>
                      <b>Showcase Skills</b>
                    </span>
                  </div>
        ...
        <div className={"frameParent5"}>
          <div className={"frameParent6"}>
            ...
            <div className={"realWorldProblemSolvingParent"}>
              ...
              <div className={"codingChallengesSimulate"}>Coding challenges simulate real-world development, helping learners apply programming concepts to build practical solutions.</div>
            </div>
          </div>
              ...
              <div className={"rectangleParent"}>
                ...
                <div className={"frameChild2"}>
                  <div className={"ellipseParent"}>
                    ...
                    <Image className={"puzzleIcon"} src="/icons/puzzle.svg" width={36} height={36} alt="" />
                ...
                <div className={"frameChild2"}>
                  <div className={"frameWrapper9"}>
                    <div className={"ellipseGroup"}>
                      ...
                      <Image className={"search02Icon"} src="/icons/search-02.svg" width={36} height={36} alt="" />
              ...
              <div className={"rectangleParent"}>
                ...
                <div className={"frameChild2"}>
                  <div className={"ellipseContainer"}>
                    ...
                    <Image className={"aiBrain01Icon"} src="/icons/ai-brain-01.svg" width={36} height={36} alt="" />
              ...
              <div className={"rectangleParent"}>
                ...
                <div className={"frameChild2"}>
                  <div className={"ellipseParent2"}>
                    ...
                    <Image className={"codeXmlIcon"} src="/icons/code-xml.svg" width={36} height={36} alt="" />
                    <div className={"buildOptimizedSolutions"}>
        ...
        <div className={"frameParent8"}>
          <div className={"frameParent9"}>
            ...
            <div className={"learnCompeteAnd"}>Learn, compete, and grow through coding challenges.</div>
          </div>
            ...
            <div className={"frameWrapper14"}>
              <div className={"frameParent15"}>
                ...
                <div className={"improveCodingEfficiencyAcParent"}>
                  <b className={"improveCodingEfficiency"}>Improve Coding Efficiency &amp; Accuracy</b>
                  <div className={"buildBetterCoding"}>Build better coding habits through regular practice and real-world challenges.</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={"frameParent22"}>
          <div className={"audienceHeader"}>
            ...
            <div className={"builtForEveryLearningJournParent"}>
              ...
              <div className={"neurolabsCodingChallenges"}>NeuroLabs Coding Challenges are suitable for:</div>
            </div>
          </div>
        ...
        <div className={"rectangleParent4"}>
          <Image className={"colleaguesDiscussingWorkProIcon"} src="/images/colleagues.webp" width={702} height={505} sizes="(max-width: 767px) 100vw, 702px" alt="Colleagues discussing work at a computer" />
            ...
            <div className={"ctaTextGroup"}>
              ...
              <b className={"challengeYourSkillsContainer"}>
                <span className={"challengeYourSkillsContainer2"}>
                  <span className={"challengeYourSkills"}>Challenge Your Skills Build Your </span>
                  <span className={"future"}>Future</span>
                </span>
              </b>
            </div>
            <div className={"solveRealCoding"}>Solve real coding challenges and grow into a confident programmer.</div>
          </div>
        </div>
      </PageScaler>
      <TalkToExpertButton />
