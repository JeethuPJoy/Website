				...
				<div className={styles.frameParent3}>
					...
					<div className={styles.frameParent7}>
						...
						<div className={styles.facultyDevelopmentWrapper}>
							<b className={styles.facultyDevelopment}>Faculty Development<br /></b>
						</div>
						<div className={styles.accreditationReadyWrapper}>
							<b className={styles.outcomeBasedLearning}>Accreditation Ready</b>
						</div>
						<Image className={styles.arrowDownBigIcon} src="/icons/arrowpink.svg" width={58} height={58} sizes="100vw" alt="" />
						<Image className={styles.arrowDownBigIcon2} src="/icons/arrowblue.svg" width={57} height={57} sizes="100vw" alt="" />
					</div>
				</div>
