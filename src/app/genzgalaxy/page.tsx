...
const GenZgalaxy: NextPage = () => {
  ...
  useEffect(() => {
    ...
    if (document.fonts?.ready) {
      document.fonts.ready.then(revealLayout).catch(revealLayout);
    } else {
      revealLayout();
    }
  ...
  return (
    <>
      <link rel="preload" as="image" href="/images/img2.png" />
      <link rel="preload" as="image" href="/images/img6.jpg" />
      <link rel="preload" as="image" href="/images/img4.jpg" />
      <link rel="preload" as="image" href="/images/img1.png" />
      <link rel="preload" as="image" href="/images/img3.png" />
      <link rel="preload" as="image" href="/images/img5.jpg" />
      <link rel="preload" as="image" href="/images/success.png" />
      <link rel="preload" as="image" href="/images/img8.jpg" />
      <link rel="preload" as="image" href="/images/img9.jpg" />
      <main className={`genzgalaxy${isLayoutReady ? " layoutReady" : ""}`} id="main-content" tabIndex={0} role="main" aria-label="Gen Z Galaxy page content">
      ...
      <div className="frameContainer">
        <div className="frameDiv">
          <div className="frameWrapper frameRotate1st">
            <Image className="frameChild heroImageStep" style={{ animationDelay: "0s" }} src="/images/img2.png" width={300} height={520} sizes="100vw" priority alt="" aria-hidden="true" />
          ...
          <div className="frameParent2">
            ...
            <div className="frameWrapper2 frameSlotLast frameRotateLast">
              <Image className="frameChild heroImageStep" style={{ animationDelay: "-2s" }} src="/images/success.png" width={300} height={520} sizes="100vw" priority alt="" aria-hidden="true" />
        ...
        <div className="frameParent3">
          ...
          <div className="frameParent5">
            <div className="genzgalaxyGroup">
              <h1 className="genzgalaxy3" style={{ margin: 0, fontWeight: 700 }}>
                <span className="gen">Gen</span>
                <span className="z">Z</span>
                <span className="gen">galaxy</span>
              </h1>
              <h2 className="aLearningSpace" style={{ margin: 0, fontWeight: 700 }}>
      ...
      <div className="frameParent6">
        <div className="frameParent7">
          <div className="frameParent8">
            ...
            <h2 className="builtForTheContainer" style={{ margin: 0, fontWeight: 700 }}>
        ...
        <div className="frameParent9">
          <div className="frameParent10">
            <div className="polygonParent">
              <svg className="polygonIcon" viewBox="0 0 300 310" aria-hidden="true" focusable="false">
                <defs>
      ...
      <div className="image20Parent">
        ...
        <div className="rectangleParent">
          <Image className="rectangleIcon" src="/images/bg.png" width={1207} height={946} sizes="100vw" priority alt="" aria-hidden="true" />
          ...
          <div className="frameParent23">
            <div className="frameParent24">
              ...
              <div className="technicalAwarenessParent">
                <h3 className="technicalAwareness" style={{ margin: 0, fontWeight: 700 }}>
                  Technical Awareness
                </h3>
            ...
            <div className="frameParent25">
              ...
              <div className="problemSolvingWrapper">
                <h3 className="problemSolving" style={{ margin: 0, fontWeight: 700 }}>
                  Problem Solving
                </h3>
              </div>
            ...
            <div className="frameParent28">
              ...
              <div className="technicalAwarenessParent">
                <div className="vectorParent">
                  ...
                  <h3 className="jobReadySkills" style={{ margin: 0, fontWeight: 700 }}>
                    Job-Ready Skills
                  </h3>
                </div>
              </div>
      ...
      <div className="frameParent29">
        <div className="wrapperPolygon16Parent">
          <div className="wrapperPolygon16">
            <div className="hexagonStack">
              <div className="hexagonMaroonOuter" />
              <div className="hexagonMaroonCut" />
              <div className="hexagonWhiteHex" />
              <div className="hexagonPhotoWrap">
                <Image className="wrapperPolygon16Child" src="/images/polygons.jpg" fill sizes="780px" alt="Students learning together" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="frameWrapper7">
              <div className="frameParent31">
                <div className="frameParent32">
                  ...
                  <h2 className="greatLearningHappensContainer" style={{ margin: 0, fontWeight: 700 }}>
            ...
            <div className="frameParent33">
              <div className="frameParent34">
                <div className="frameWrapper8">
                  <div className="frameParent35">
                    <div className="checkCircle checkCircleGreen">
                    ...
                    <div className="shareThoughts">Share Thoughts</div>
                  </div>
                </div>
                <div className="frameWrapper9">
                  <div className="frameParent35">
                    <div className="checkCircle checkCirclePink">
                      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false">
                        <path d="M11.4743 17.3058C14.4874 14.0819 17.3962 11.8949 21.0501 8.79776C22.1437 7.87072 22.3126 6.24578 21.4547 5.09453C20.5429 3.87098 18.8103 3.62642 17.6376 4.59913C14.2907 7.37521 11.6868 10.0482 9.21679 12.9051C9.08718 13.055 9.02237 13.13 8.95511 13.1722C8.78453 13.2792 8.57138 13.2803 8.3997 13.1751C8.33199 13.1336 8.26707 13.0601 8.13722 12.9131L6.82103 11.4229C5.6201 10.0631 3.46608 10.2137 2.46339 11.7274C1.76171 12.7867 1.86569 14.1905 2.71567 15.1334L4.7796 17.4229C6.32334 19.1353 7.09521 19.9916 8.02185 19.9999C8.94849 20.0083 9.79043 19.1075 11.4743 17.3058Z" stroke="currentColor" strokeWidth="1.5" />
                      </svg>
                    </div>
                    <div className="shareThoughts">Build Together</div>
                  </div>
                </div>
              </div>
              <div className="frameParent37">
                <div className="frameWrapper10">
                  <div className="frameParent35">
                    <div className="checkCircle checkCirclePurple">
                      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false">
                        <path d="M11.4743 17.3058C14.4874 14.0819 17.3962 11.8949 21.0501 8.79776C22.1437 7.87072 22.3126 6.24578 21.4547 5.09453C20.5429 3.87098 18.8103 3.62642 17.6376 4.59913C14.2907 7.37521 11.6868 10.0482 9.21679 12.9051C9.08718 13.055 9.02237 13.13 8.95511 13.1722C8.78453 13.2792 8.57138 13.2803 8.3997 13.1751C8.33199 13.1336 8.26707 13.0601 8.13722 12.9131L6.82103 11.4229C5.6201 10.0631 3.46608 10.2137 2.46339 11.7274C1.76171 12.7867 1.86569 14.1905 2.71567 15.1334L4.7796 17.4229C6.32334 19.1353 7.09521 19.9916 8.02185 19.9999C8.94849 20.0083 9.79043 19.1075 11.4743 17.3058Z" stroke="currentColor" strokeWidth="1.5" />
                      </svg>
                    </div>
                    <div className="shareThoughts">Learn from Others</div>
                  </div>
                </div>
                <div className="frameWrapper11">
                  <div className="frameParent35">
                    <div className="checkCircle checkCircleTeal">
                      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false">
                        <path d="M11.4743 17.3058C14.4874 14.0819 17.3962 11.8949 21.0501 8.79776C22.1437 7.87072 22.3126 6.24578 21.4547 5.09453C20.5429 3.87098 18.8103 3.62642 17.6376 4.59913C14.2907 7.37521 11.6868 10.0482 9.21679 12.9051C9.08718 13.055 9.02237 13.13 8.95511 13.1722C8.78453 13.2792 8.57138 13.2803 8.3997 13.1751C8.33199 13.1336 8.26707 13.0601 8.13722 12.9131L6.82103 11.4229C5.6201 10.0631 3.46608 10.2137 2.46339 11.7274C1.76171 12.7867 1.86569 14.1905 2.71567 15.1334L4.7796 17.4229C6.32334 19.1353 7.09521 19.9916 8.02185 19.9999C8.94849 20.0083 9.79043 19.1075 11.4743 17.3058Z" stroke="currentColor" strokeWidth="1.5" />
                      </svg>
                    </div>
                    <div className="shareThoughts">Stay connected</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="frameParent46">
          <div className="frameParent47">
            <div className="frameParent48">
              ...
              <h2 className="aSimplerWayContainer" style={{ margin: 0, fontWeight: 700 }}>
...
//         <div className="frameDiv">
//           <div className="frameWrapper frameRotate1st">
//             <Image className="frameChild heroImageStep" style={{ animationDelay: "0s" }} src="/images/img2.webp" width={300} height={520} sizes="100vw" loading="eager" alt="" aria-hidden="true" />
//             <Image className="frameChild heroImageStep heroImg6Position" style={{ animationDelay: "-3s" }} src="/images/img6.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
//             <Image className="frameChild heroImageStep" style={{ animationDelay: "-6s" }} src="/images/img4.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
//           </div>
//           <div className="frameParent2">
//             <div className="frameWrapper2 frameSlotMiddle frameRotateMiddle">
//               <Image className="frameChild heroImageStep" style={{ animationDelay: "-1s" }} src="/images/img1.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
//               <Image className="frameChild heroImageStep" style={{ animationDelay: "-4s" }} src="/images/img3.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
//               <Image className="frameChild heroImageStep" style={{ animationDelay: "-7s" }} src="/images/img5.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
//             </div>
//             <div className="frameWrapper2 frameSlotLast frameRotateLast">
//               <Image className="frameChild heroImageStep" style={{ animationDelay: "-2s" }} src="/images/success.webp" width={300} height={520} sizes="100vw" loading="eager" alt="" aria-hidden="true" />
//               <Image className="frameChild heroImageStep" style={{ animationDelay: "-5s" }} src="/images/img8.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
//               <Image className="frameChild heroImageStep heroImg9Position" style={{ animationDelay: "-8s" }} src="/images/img9.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
//             </div>
//           </div>
//         </div>
//         <div className="frameParent3">
...
//               <div className="learnMoreFlat">Learn More</div>
//             </div>
//             <BookDemoTrigger className="frameWrapper4">
//               <div className="explorePlatformParent">
//                 <div className="explorePlatform">Explore Platform</div>
//               </div>
//             </BookDemoTrigger>
...
//         <div className="image20" />
//         <div className="rectangleParent">
//           <Image className="rectangleIcon" src="/images/bg.webp" width={1207} height={946} sizes="100vw" loading="eager" alt="" aria-hidden="true" />
//           <div className="wrapperPolygon14">
//             <div className="wrapperPolygon14Child" aria-hidden="true" />
//           </div>
//           <Image className="successfulYoungBusinessmanSIcon" src="/images/success.webp" width={653} height={978} sizes="100vw" alt="" aria-hidden="true" />
//           <div className="frameChild18" />
//           <div className="frameParent12">
//             <div className="frameParent13">
//               <div className="frameParent14">
...
//               <div className="hexagonWhiteHex" />
//               <div className="hexagonPhotoWrap">
//                 <Image className="wrapperPolygon16Child" src="/images/polygons.webp" fill sizes="780px" alt="Students learning together" />
//               </div>
//             </div>
//           </div>
//         </div>
...
//       <div className="rectangleGroup">
//         <Image className="rectangleIcon2" src="/images/background2.webp" width={1280} height={500} sizes="100vw" alt="" aria-hidden="true" />
//         <div className="image202" />
//         <div className="frameParent46">
//           <div className="frameParent47">
//             <div className="frameParent48">
...
//             <div className="smarterFlexibleLearning">Smarter, flexible learning that adapts to your pace and goals</div>
//           </div>
//           <BookDemoTrigger className="frameWrapper12">
//             <div className="explorePlatformWrapper">
//               <div className="explorePlatform2">Explore Platform</div>
//             </div>
//           </BookDemoTrigger>
//         </div>
//         <Image className="youngPeopleRowWithThumbsUIcon" src="/images/young.webp" width={772} height={500} sizes="100vw" alt="" aria-hidden="true" />
//       </div>
//       <BookDemoButton />
//     </main>
//   );
