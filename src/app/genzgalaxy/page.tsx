...
const PRELOADED_HERO_IMAGES = ["/images/img2.webp", "/images/img6.webp", "/images/img4.webp", "/images/img1.webp", "/images/img3.webp", "/images/img5.webp", "/images/success.webp", "/images/img8.webp", "/images/img9.webp"];
    ...
    <>
      ...
      <main className={`${styles.genzgalaxy}${isLayoutReady ? ` ${styles.layoutReady}` : ""}`} id="main-content" tabIndex={0} role="main" aria-label="Gen Z Galaxy page content">
        ...
        <div className={styles.frameContainer}>
          <div className={styles.frameDiv}>
            <div className={`${styles.frameWrapper} ${styles.frameRotate1st}`}>
              <Image className={`${styles.frameChild} ${styles.heroImageStep}`} style={{ animationDelay: "0s" }} src="/images/img2.webp" width={300} height={520} sizes="100vw" priority alt="" aria-hidden="true" />
              <Image className={`${styles.frameChild} ${styles.heroImageStep} ${styles.heroImg6Position}`} style={{ animationDelay: "-3s" }} src="/images/img6.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
              <Image className={`${styles.frameChild} ${styles.heroImageStep}`} style={{ animationDelay: "-6s" }} src="/images/img4.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
            </div>
            <div className={styles.frameParent2}>
              <div className={`${styles.frameWrapper2} ${styles.frameSlotMiddle} ${styles.frameRotateMiddle}`}>
                <Image className={`${styles.frameChild} ${styles.heroImageStep}`} style={{ animationDelay: "-1s" }} src="/images/img1.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
                <Image className={`${styles.frameChild} ${styles.heroImageStep}`} style={{ animationDelay: "-4s" }} src="/images/img3.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
                <Image className={`${styles.frameChild} ${styles.heroImageStep}`} style={{ animationDelay: "-7s" }} src="/images/img5.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
              </div>
              <div className={`${styles.frameWrapper2} ${styles.frameSlotLast} ${styles.frameRotateLast}`}>
                <Image className={`${styles.frameChild} ${styles.heroImageStep}`} style={{ animationDelay: "-2s" }} src="/images/success.webp" width={300} height={520} sizes="100vw" priority alt="" aria-hidden="true" />
                <Image className={`${styles.frameChild} ${styles.heroImageStep}`} style={{ animationDelay: "-5s" }} src="/images/img8.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
                <Image className={`${styles.frameChild} ${styles.heroImageStep} ${styles.heroImg9Position}`} style={{ animationDelay: "-8s" }} src="/images/img9.webp" width={300} height={520} sizes="100vw" alt="" aria-hidden="true" />
              </div>
            </div>
          </div>
          <div className={styles.frameParent3}>
            <div className={styles.frameParent4}>
              ...
              <div className={styles.frameWrapper4}>
                <Link href="/" className={styles.explorePlatformParent}>
            ...
            <div className={styles.frameParent12}>
              <div className={styles.frameParent13}>
                <div className={styles.frameParent14}>
                  ...
                  <h2 className={styles.learnYourWay}>Learn Your Way, Every Day</h2>
                </div>
        ...
        <div className={styles.rectangleGroup}>
          <Image className={styles.rectangleIcon2} src="/images/background2.jpeg" width={1280} height={500} sizes="100vw" alt="" aria-hidden="true" />
