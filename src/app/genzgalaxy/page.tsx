      ...
      <div className="frameContainer">
        <div className="frameDiv">
          <div className="frameWrapper frameRotate1st">
            <Image className="frameChild heroImageStep" style={{ animationDelay: "0s" }} src="/images/img2.png" width={300} height={520} sizes="100vw" loading="eager" alt="" aria-hidden="true" />
          ...
          <div className="frameParent2">
            ...
            <div className="frameWrapper2 frameSlotLast frameRotateLast">
              <Image className="frameChild heroImageStep" style={{ animationDelay: "-2s" }} src="/images/success.png" width={300} height={520} sizes="100vw" loading="eager" alt="" aria-hidden="true" />
